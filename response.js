...
var arvlMsg3 = []
var arvlCd = []
var ordkey = [] // 열차 도착 예정 순번
var barvlDt = [] // 열차 도착 예정 초
...
//=======================================================================================================================
        ...
        else if(msg.indexOf("/지하철")==0||msg.indexOf("/전철")==0||msg.indexOf("/메트로")==0){
            try{ // try
                var str_Metro = ""
                var station = msg.replace("/지하철", "").replace("/전철","").replace("/메트로","").rmspace().replace(/ /g,"")
                //var station = msg.split(" ")[1]


                if(station!="춘의역"&&station.substring(station.length-1,station.length)=="역"){
                ...
                var metroError = sortMetro2(station)
                if(metroError==0){
                    r.reply("운행중인 전철이 없습니다.")
                    return 0;
                }
                if(metroError==1){
                    r.reply("서버가 응답하지 않습니다. 잠시 후 다시 시도해주세요.")
                    return 0;
                }

//============================================================   1호선   ==================================================================
                if( stationLine.I("1001") ){
                    str_Metro += "\n=====1호선 상행============\n\n"
                    if( s1U[0]==undefined ){
                        str_Metro += "운행중인 열차가 없습니다.\n"
                    }
                    if( s1U[0]!=undefined ){
                        str_Metro += "1."+s1U[0].split("||")[1].Metro()+"역 ("+s1U[0].split("||")[0]+") ("+s1U[0].split("||")[3]+")\n"
                    }
                    if( s1U[1]!=undefined ){
                        str_Metro += "2."+s1U[1].split("||")[1].Metro()+"역 ("+s1U[1].split("||")[0]+") ("+s1U[1].split("||")[3]+")\n"
                    }
                    if( s1U[2]!=undefined ){
                        str_Metro += "3."+s1U[2].split("||")[1].Metro()+"역 ("+s1U[2].split("||")[0]+") ("+s1U[2].split("||")[3]+")\n"
                    }
                    str_Metro += "\n=====1호선 하행============\n\n"
                    if( s1D[0]==undefined ){
                        str_Metro += "운행중인 열차가 없습니다.\n"
                    ...
                    if( s1D[0]!=undefined ){
                        str_Metro += "1."+s1D[0].split("||")[1].Metro()+"역 ("+s1D[0].split("||")[0]+") ("+s1D[0].split("||")[3]+")\n"
                    }
                    if( s1D[1]!=undefined ){
                        str_Metro += "2."+s1D[1].split("||")[1].Metro()+"역 ("+s1D[1].split("||")[0]+") ("+s1D[1].split("||")[3]+")\n"
                    }
                    if( s1D[2]!=undefined ){
                        str_Metro += "3."+s1D[2].split("||")[1].Metro()+"역 ("+s1D[2].split("||")[0]+") ("+s1D[2].split("||")[3]+")\n"
                    }
                }
//============================================================   2호선   ==================================================================
                if( stationLine.I("1002") ){
                    str_Metro += "\n=====2호선 내선(시계방향)=====\n\n"
                    if( s2U[0]==undefined ){
                        str_Metro += "운행중인 열차가 없습니다.\n"
                    }
                    if( s2U[0]!=undefined ){
                        str_Metro += "1."+s2U[0].split("||")[1].Metro()+"역 ("+s2U[0].split("||")[0]+")\n"
                    }
                    if( s2U[1]!=undefined ){
                        str_Metro += "2."+s2U[1].split("||")[1].Metro()+"역 ("+s2U[1].split("||")[0]+")\n"
                    }
                    if( s2U[2]!=undefined ){
                        str_Metro += "3."+s2U[2].split("||")[1].Metro()+"역 ("+s2U[2].split("||")[0]+")\n"
                    }
                    str_Metro += "\n=====2호선 외선(반시계방향)===\n\n"
                    if( s2D[0]==undefined ){
                        str_Metro += "운행중인 열차가 없습니다.\n"
                    ...
                    if( s2D[0]!=undefined ){
                        str_Metro += "1."+s2D[0].split("||")[1].Metro()+"역 ("+s2D[0].split("||")[0]+")\n"
                    }
                    if( s2D[1]!=undefined ){
                        str_Metro += "2."+s2D[1].split("||")[1].Metro()+"역 ("+s2D[1].split("||")[0]+")\n"
                    }
                    if( s2D[2]!=undefined ){
                        str_Metro += "3."+s2D[2].split("||")[1].Metro()+"역 ("+s2D[2].split("||")[0]+")\n"
                    }
                }
//============================================================   3호선   ==================================================================
                if( stationLine.I("1003") ){
                    str_Metro += "\n=====3호선 상행============\n\n"
                    if( s3U[0]==undefined ){
                        str_Metro += "운행중인 열차가 없습니다.\n"
                    }
                    if( s3U[0]!=undefined ){
                        str_Metro += "1."+s3U[0].split("||")[1].Metro()+"역 ("+s3U[0].split("||")[0]+")\n"
                    }
                    if( s3U[1]!=undefined ){
                        str_Metro += "2."+s3U[1].split("||")[1].Metro()+"역 ("+s3U[1].split("||")[0]+")\n"
                    }
                    if( s3U[2]!=undefined ){
                        str_Metro += "3."+s3U[2].split("||")[1].Metro()+"역 ("+s3U[2].split("||")[0]+")\n"
                    }
                    str_Metro += "\n=====3호선 하행============\n\n"
                    if( s3D[0]==undefined ){
                        str_Metro += "운행중인 열차가 없습니다.\n"
                    ...
                    if( s3D[0]!=undefined ){
                        str_Metro += "1."+s3D[0].split("||")[1].Metro()+"역 ("+s3D[0].split("||")[0]+")\n"
                    }
                    if( s3D[1]!=undefined ){
                        str_Metro += "2."+s3D[1].split("||")[1].Metro()+"역 ("+s3D[1].split("||")[0]+")\n"
                    }
                    if( s3D[2]!=undefined ){
                        str_Metro += "3."+s3D[2].split("||")[1].Metro()+"역 ("+s3D[2].split("||")[0]+")\n"
                    }
                }
//============================================================   4호선   ==================================================================
                if( stationLine.I("1004") ){
                    str_Metro += "\n=====4호선 상행============\n\n"
                    if( s4U[0]==undefined ){
                        str_Metro += "운행중인 열차가 없습니다.\n"
                    }
                    if( s4U[0]!=undefined ){
                        str_Metro += "1."+s4U[0].split("||")[1].Metro()+"역 ("+s4U[0].split("||")[0]+")\n"
                    }
                    if( s4U[1]!=undefined ){
                        str_Metro += "2."+s4U[1].split("||")[1].Metro()+"역 ("+s4U[1].split("||")[0]+")\n"
                    }
                    if( s4U[2]!=undefined ){
                        str_Metro += "3."+s4U[2].split("||")[1].Metro()+"역 ("+s4U[2].split("||")[0]+")\n"
                    }
                    str_Metro += "\n=====4호선 하행============\n\n"
                    if( s4D[0]==undefined ){
                        str_Metro += "운행중인 열차가 없습니다.\n"
                    ...
                    if( s4D[0]!=undefined ){
                        str_Metro += "1."+s4D[0].split("||")[1].Metro()+"역 ("+s4D[0].split("||")[0]+")\n"
                    }
                    if( s4D[1]!=undefined ){
                        str_Metro += "2."+s4D[1].split("||")[1].Metro()+"역 ("+s4D[1].split("||")[0]+")\n"
                    }
                    if( s4D[2]!=undefined ){
                        str_Metro += "3."+s4D[2].split("||")[1].Metro()+"역 ("+s4D[2].split("||")[0]+")\n"
                    }
                }
//============================================================   5호선   ==================================================================
                if( stationLine.I("1005") ){
                    str_Metro += "\n=====5호선 상행============\n\n"
                    if( s5U[0]==undefined ){
                        str_Metro += "운행중인 열차가 없습니다.\n"
                    }
                    if( s5U[0]!=undefined ){
                        str_Metro += "1."+s5U[0].split("||")[1].Metro()+"역 ("+s5U[0].split("||")[0]+")\n"
                    }
                    if( s5U[1]!=undefined ){
                        str_Metro += "2."+s5U[1].split("||")[1].Metro()+"역 ("+s5U[1].split("||")[0]+")\n"
                    }
                    if( s5U[2]!=undefined ){
                        str_Metro += "3."+s5U[2].split("||")[1].Metro()+"역 ("+s5U[2].split("||")[0]+")\n"
                    }
                    str_Metro += "\n=====5호선 하행============\n\n"
                    if( s5D[0]==undefined ){
                        str_Metro += "운행중인 열차가 없습니다.\n"
                    ...
                    if( s5D[0]!=undefined ){
                        str_Metro += "1."+s5D[0].split("||")[1].Metro()+"역 ("+s5D[0].split("||")[0]+")\n"
                    }
                    if( s5D[1]!=undefined ){
                        str_Metro += "2."+s5D[1].split("||")[1].Metro()+"역 ("+s5D[1].split("||")[0]+")\n"
                    }
                    if( s5D[2]!=undefined ){
                        str_Metro += "3."+s5D[2].split("||")[1].Metro()+"역 ("+s5D[2].split("||")[0]+")\n"
                    }
                }
//============================================================   6호선   ==================================================================
                if( stationLine.I("1006") ){
                    str_Metro += "\n=====6호선 상행============\n\n"
                    if( s6U[0]==undefined ){
                        str_Metro += "운행중인 열차가 없습니다.\n"
                    }
                    if( s6U[0]!=undefined ){
                        str_Metro += "1."+s6U[0].split("||")[1].Metro()+"역 ("+s6U[0].split("||")[0]+")\n"
                    }
                    if( s6U[1]!=undefined ){
                        str_Metro += "2."+s6U[1].split("||")[1].Metro()+"역 ("+s6U[1].split("||")[0]+")\n"
                    }
                    if( s6U[2]!=undefined ){
                        str_Metro += "3."+s6U[2].split("||")[1].Metro()+"역 ("+s6U[2].split("||")[0]+")\n"
                    }
                    str_Metro += "\n=====6호선 하행============\n\n"
                    if( s6D[0]==undefined ){
                        str_Metro += "운행중인 열차가 없습니다.\n"
                    ...
                    if( s6D[0]!=undefined ){
                        str_Metro += "1."+s6D[0].split("||")[1].Metro()+"역 ("+s6D[0].split("||")[0]+")\n"
                    }
                    if( s6D[1]!=undefined ){
                        str_Metro += "2."+s6D[1].split("||")[1].Metro()+"역 ("+s6D[1].split("||")[0]+")\n"
                    }
                    if( s6D[2]!=undefined ){
                        str_Metro += "3."+s6D[2].split("||")[1].Metro()+"역 ("+s6D[2].split("||")[0]+")\n"
                    }
                }
//============================================================   7호선   ==================================================================
                if( stationLine.I("1007") ){
                    str_Metro += "\n=====7호선 상행============\n\n"
                    if( s7U[0]==undefined ){
                        str_Metro += "운행중인 열차가 없습니다.\n"
                    }
                    if( s7U[0]!=undefined ){
                        str_Metro += "1."+s7U[0].split("||")[1].Metro()+"역 ("+s7U[0].split("||")[0]+")\n"
                    }
                    if( s7U[1]!=undefined ){
                        str_Metro += "2."+s7U[1].split("||")[1].Metro()+"역 ("+s7U[1].split("||")[0]+")\n"
                    }
                    if( s7U[2]!=undefined ){
                        str_Metro += "3."+s7U[2].split("||")[1].Metro()+"역 ("+s7U[2].split("||")[0]+")\n"
                    }
                    str_Metro += "\n=====7호선 하행============\n\n"
                    if( s7D[0]==undefined ){
                        str_Metro += "운행중인 열차가 없습니다.\n"
                    ...
                    if( s7D[0]!=undefined ){
                        str_Metro += "1."+s7D[0].split("||")[1].Metro()+"역 ("+s7D[0].split("||")[0]+")\n"
                    }
                    if( s7D[1]!=undefined ){
                        str_Metro += "2."+s7D[1].split("||")[1].Metro()+"역 ("+s7D[1].split("||")[0]+")\n"
                    }
                    if( s7D[2]!=undefined ){
                        str_Metro += "3."+s7D[2].split("||")[1].Metro()+"역 ("+s7D[2].split("||")[0]+")\n"
                    }
                }
//============================================================   8호선   ==================================================================
                if( stationLine.I("1008") ){
                    str_Metro += "\n=====8호선 상행============\n\n"
                    if( s8U[0]==undefined ){
                        str_Metro += "운행중인 열차가 없습니다.\n"
                    }
                    if( s8U[0]!=undefined ){
                        str_Metro += "1."+s8U[0].split("||")[1].Metro()+"역 ("+s8U[0].split("||")[0]+")\n"
                    }
                    if( s8U[1]!=undefined ){
                        str_Metro += "2."+s8U[1].split("||")[1].Metro()+"역 ("+s8U[1].split("||")[0]+")\n"
                    }
                    if( s8U[2]!=undefined ){
                        str_Metro += "3."+s8U[2].split("||")[1].Metro()+"역 ("+s8U[2].split("||")[0]+")\n"
                    }
                    str_Metro += "\n=====8호선 하행============\n\n"
                    if( s8D[0]==undefined ){
                        str_Metro += "운행중인 열차가 없습니다.\n"
                    ...
                    if( s8D[0]!=undefined ){
                        str_Metro += "1."+s8D[0].split("||")[1].Metro()+"역 ("+s8D[0].split("||")[0]+")\n"
                    }
                    if( s8D[1]!=undefined ){
                        str_Metro += "2."+s8D[1].split("||")[1].Metro()+"역 ("+s8D[1].split("||")[0]+")\n"
                    }
                    if( s8D[2]!=undefined ){
                        str_Metro += "3."+s8D[2].split("||")[1].Metro()+"역 ("+s8D[2].split("||")[0]+")\n"
                    }
                }
//============================================================   9호선   ==================================================================
                if( stationLine.I("1009") ){
                    str_Metro += "\n=====9호선 상행============\n\n"
                    if( s9U[0]==undefined ){
                        str_Metro += "운행중인 열차가 없습니다.\n"
                    }
                    if( s9U[0]!=undefined ){
                        str_Metro += "1."+s9U[0].split("||")[1].Metro()+"역 ("+s9U[0].split("||")[0]+")\n"
                    }
                    if( s9U[1]!=undefined ){
                        str_Metro += "2."+s9U[1].split("||")[1].Metro()+"역 ("+s9U[1].split("||")[0]+")\n"
                    }
                    if( s9U[2]!=undefined ){
                        str_Metro += "3."+s9U[2].split("||")[1].Metro()+"역 ("+s9U[2].split("||")[0]+")\n"
                    }
                    str_Metro += "\n=====9호선 하행============\n\n"
                    if( s9D[0]==undefined ){
                        str_Metro += "운행중인 열차가 없습니다.\n"
                    ...
                    if( s9D[0]!=undefined ){
                        str_Metro += "1."+s9D[0].split("||")[1].Metro()+"역 ("+s9D[0].split("||")[0]+")\n"
                    }
                    if( s9D[1]!=undefined ){
                        str_Metro += "2."+s9D[1].split("||")[1].Metro()+"역 ("+s9D[1].split("||")[0]+")\n"
                    }
                    if( s9D[2]!=undefined ){
                        str_Metro += "3."+s9D[2].split("||")[1].Metro()+"역 ("+s9D[2].split("||")[0]+")\n"
                    }
                }
//============================================================   경의중앙선   ==================================================================
                if( stationLine.I("1063") ){
                    str_Metro += "\n===경의중앙선 상행(문산방향)===\n\n"
                    if( KMU[0]==undefined ){
                        str_Metro += "운행중인 열차가 없습니다.\n"
                    }
                    if( KMU[0]!=undefined ){
                        str_Metro += "1."+KMU[0].split("||")[1].Metro()+"역 ("+KMU[0].split("||")[0]+") ("+KMU[0].split("||")[3]+")\n"
                    }
                    if( KMU[1]!=undefined ){
                        str_Metro += "2."+KMU[1].split("||")[1].Metro()+"역 ("+KMU[1].split("||")[0]+") ("+KMU[1].split("||")[3]+")\n"
                    }
                    if( KMU[2]!=undefined ){
                        str_Metro += "3."+KMU[2].split("||")[1].Metro()+"역 ("+KMU[2].split("||")[0]+") ("+KMU[2].split("||")[3]+")\n"
                    }
                    str_Metro += "\n===경의중앙선 하행(용문방향)===\n\n"
                    if( KMD[0]==undefined ){
                        str_Metro += "운행중인 열차가 없습니다.\n"
                    ...
                    if( KMD[0]!=undefined ){
                        str_Metro += "1."+KMD[0].split("||")[1].Metro()+"역 ("+KMD[0].split("||")[0]+") ("+KMD[0].split("||")[3]+")\n"
                    }
                    if( KMD[1]!=undefined ){
                        str_Metro += "2."+KMD[1].split("||")[1].Metro()+"역 ("+KMD[1].split("||")[0]+") ("+KMD[1].split("||")[3]+")\n"
                    }
                    if( KMD[2]!=undefined ){
                        str_Metro += "3."+KMD[2].split("||")[1].Metro()+"역 ("+KMD[2].split("||")[0]+") ("+KMD[2].split("||")[3]+")\n"
                    }
                }
//============================================================   분당선   ==================================================================
                if( stationLine.I("1075") ){
                    str_Metro += "\n=====분당선 상행===========\n\n"
                    if( OBU[0]==undefined ){
                        str_Metro += "운행중인 열차가 없습니다.\n"
                    }
                    if( OBU[0]!=undefined ){
                        str_Metro += "1."+OBU[0].split("||")[1].Metro()+"역 ("+OBU[0].split("||")[0]+")\n"
                    }
                    if( OBU[1]!=undefined ){
                        str_Metro += "2."+OBU[1].split("||")[1].Metro()+"역 ("+OBU[1].split("||")[0]+")\n"
                    }
                    if( OBU[2]!=undefined ){
                        str_Metro += "3."+OBU[2].split("||")[1].Metro()+"역 ("+OBU[2].split("||")[0]+")\n"
                    }
                    str_Metro += "\n=====분당선 하행===========\n\n"
                    if( OBD[0]==undefined ){
                        str_Metro += "운행중인 열차가 없습니다.\n"
                    ...
                    if( OBD[0]!=undefined ){
                        str_Metro += "1."+OBD[0].split("||")[1].Metro()+"역 ("+OBD[0].split("||")[0]+")\n"
                    }
                    if( OBD[1]!=undefined ){
                        str_Metro += "2."+OBD[1].split("||")[1].Metro()+"역 ("+OBD[1].split("||")[0]+")\n"
                    }
                    if( OBD[2]!=undefined ){
                        str_Metro += "3."+OBD[2].split("||")[1].Metro()+"역 ("+OBD[2].split("||")[0]+")\n"
                    }
                }
//============================================================   신분당선   ==================================================================
                if( stationLine.I("1077") ){
                    str_Metro += "\n=====신분당선 상행==========\n\n"
                    if( NBU[0]==undefined ){
                        str_Metro += "운행중인 열차가 없습니다.\n"
                    }
                    if( NBU[0]!=undefined ){
                        str_Metro += "1."+NBU[0].split("||")[1].Metro()+"역 ("+NBU[0].split("||")[0]+")\n"
                    }
                    if( NBU[1]!=undefined ){
                        str_Metro += "2."+NBU[1].split("||")[1].Metro()+"역 ("+NBU[1].split("||")[0]+")\n"
                    }
                    if( NBU[2]!=undefined ){
                        str_Metro += "3."+NBU[2].split("||")[1].Metro()+"역 ("+NBU[2].split("||")[0]+")\n"
                    }
                    str_Metro += "\n=====신분당선 하행==========\n\n"
                    if( NBD[0]==undefined ){
                        str_Metro += "운행중인 열차가 없습니다.\n"
                    ...
                    if( NBD[0]!=undefined ){
                        str_Metro += "1."+NBD[0].split("||")[1].Metro()+"역 ("+NBD[0].split("||")[0]+")\n"
                    }
                    if( NBD[1]!=undefined ){
                        str_Metro += "2."+NBD[1].split("||")[1].Metro()+"역 ("+NBD[1].split("||")[0]+")\n"
                    }
                    if( NBD[2]!=undefined ){
                        str_Metro += "3."+NBD[2].split("||")[1].Metro()+"역 ("+NBD[2].split("||")[0]+")\n"
                    }
                }
//============================================================   공항철도   ==================================================================
                if( stationLine.I("1065") ){
                    str_Metro += "\n=====공항철도 상행==========\n\n"
                    if( AFU[0]==undefined ){
                        str_Metro += "운행중인 열차가 없습니다.\n"
                    }
                    if( AFU[0]!=undefined ){
                        str_Metro += "1."+AFU[0].split("||")[1].Metro()+"역 ("+AFU[0].split("||")[0]+")\n"
                    }
                    if( AFU[1]!=undefined ){
                        str_Metro += "2."+AFU[1].split("||")[1].Metro()+"역 ("+AFU[1].split("||")[0]+")\n"
                    }
                    if( AFU[2]!=undefined ){
                        str_Metro += "3."+AFU[2].split("||")[1].Metro()+"역 ("+AFU[2].split("||")[0]+")\n"
                    }
                    str_Metro += "\n=====공항철도 하행==========\n\n"
                    if( AFD[0]==undefined ){
                        str_Metro += "운행중인 열차가 없습니다.\n"
                    ...
                    if( AFD[0]!=undefined ){
                        str_Metro += "1."+AFD[0].split("||")[1].Metro()+"역 ("+AFD[0].split("||")[0]+")\n"
                    }
                    if( AFD[1]!=undefined ){
                        str_Metro += "2."+AFD[1].split("||")[1].Metro()+"역 ("+AFD[1].split("||")[0]+")\n"
                    }
                    if( AFD[2]!=undefined ){
                        str_Metro += "3."+AFD[2].split("||")[1].Metro()+"역 ("+AFD[2].split("||")[0]+")\n"
                    }
                }
//============================================================   경춘선   ==================================================================
                if( stationLine.I("1067") ){
                    str_Metro += "\n=====경춘선 상행===========\n\n"
                    if( KCU[0]==undefined ){
                        str_Metro += "운행중인 열차가 없습니다.\n"
                    }
                    if( KCU[0]!=undefined ){
                        str_Metro += "1."+KCU[0].split("||")[1].Metro()+"역 ("+KCU[0].split("||")[0]+")\n"
                    }
                    if( KCU[1]!=undefined ){
                        str_Metro += "2."+KCU[1].split("||")[1].Metro()+"역 ("+KCU[1].split("||")[0]+")\n"
                    }
                    if( KCU[2]!=undefined ){
                        str_Metro += "3."+KCU[2].split("||")[1].Metro()+"역 ("+KCU[2].split("||")[0]+")\n"
                    }
                    str_Metro += "\n=====경춘선 하행===========\n\n"
                    if( KCD[0]==undefined ){
                        str_Metro += "운행중인 열차가 없습니다.\n"
                    ...
                    if( KCD[0]!=undefined ){
                        str_Metro += "1."+KCD[0].split("||")[1].Metro()+"역 ("+KCD[0].split("||")[0]+")\n"
                    }
                    if( KCD[1]!=undefined ){
                        str_Metro += "2."+KCD[1].split("||")[1].Metro()+"역 ("+KCD[1].split("||")[0]+")\n"
                    }
                    if( KCD[2]!=undefined ){
                        str_Metro += "3."+KCD[2].split("||")[1].Metro()+"역 ("+KCD[2].split("||")[0]+")\n"
                    }
                }

                str_Metro +="\n========================"
                //r.reply(str_Metro)
                r.reply(str_Metro.cut(12))
            } // try
            catch(e){
                r.reply("에러 : 잘못된 역명이거나 서버 오류입니다. 다시 시도해주세요")
            }
            finally{
            }
...
//=======================================================================================================================
        /*
		if( (msg=="-학식") || (msg=="/학식"&&isGroupChat==false) ){
			var haksikDate = nowyear.toString()+nowmonth0.toString()+nowdate0.toString()
			if(nowday=="6"){
				r.reply("토요일은 학식을 제공하지 않습니다.")
			}
			else if(nowday=="0"){
				r.reply("일요일은 학식을 제공하지 않습니다.")
			}
			else{
				r.reply(haksik(haksikDate))
			}
		}
		*/
        ...
        if( msg.indexOf("/")==0 &&
            ...
            &&(isGroupChat==false||room=="노중현,이재홍,이상민,노은총,박성원"||room=="노중현,이재홍,이상민,노은총,박성원"||room=="퀴푸 사담방"||room=="봇장난")
        ) {
...
//==================================================================================================================================
        ...
        if(getDB("disableAll_"+room)==1){}
        else{

            // 고먐미
            if(msg.indexOf("고먐미")!=-1||msg.indexOf("먀몸미")!=-1){
                r.intervalReply("고먐미"+room,"http://sirip.ga/s/catt"+(Rand2+1),120)
            }

            //고양이
            if((msg.indexOf("고양이")!=-1||msg.indexOf("야옹이")!=-1||msg.indexOf("냥이")!=-1||msg.indexOf("떼껄룩")!=-1)&&getNum("DB_고양이")==1){
                r.intervalReply("고양이"+room,"http://sirip.ga/s/cat"+(Randcat+1),3600)
            }
            //우즈키
            if(msg.indexOf("우즈키")!=-1){
                r.intervalReply("우즈키"+room,"http://sirip.ga/s/uzuki"+(Randu+1),90)
            }
        }
...
//==================================================================================================================================
        ...
        if(msg=="/WTI"||msg=="/기름"||msg=="/유가"||msg=="/원유"||msg=="/wti")		{
            var WTI_Temp = []
            WTI_Temp = WTI_parse()
            sendKalingImage(room,WTI_Temp[2],"","WTI","",318,159)
            r.reply(WTI_Temp[0])
            r.reply(WTI_Temp[1])
        }
        if(msg=="/천가"||msg=="/천연가스"||msg=="/가스"||msg=="/천연")		{
            ...
            sendKalingImage(room,natural_Gas_Temp[2],"","천연가스","",665,412)
        ...
        if(msg=="/금")		{
            ...
            sendKalingImage(room,gold_Temp[2],"","금","",658,408)
            r.reply(gold_Temp[0])
            r.reply(gold_Temp[1])
        }
        if(msg=="/달러")		{
            var USD_Temp = []
            USD_Temp = USD_parse()
            sendKalingImage(room,USD_Temp[2],"","미국 달러","",658,408)
            r.reply(USD_Temp[0])
            //r.reply(USD_Temp[1])
        }
        if(msg=="/나스닥")		{
...
//=====================================================================================================================================
        ...
        if(room=="시갤톡방"&&msg=="/포인트"){
            var strPoint = ""
            strPoint += "/포인트확인\n"
            strPoint += "/고꿈셔터 (10포인트)(3분)\n"
            strPoint += "/고꿈포인트기부 [숫자] [보낼메시지]\n"
            strPoint += "/고꿈포인트착취 [숫자] [보낼메시지]\n"
            strPoint += "/채팅추적 [숫자] [추적할닉네임]"
            r.reply(strPoint)
        }

        /*
		//if(room=="시갤톡방"&&sg_count<100){
		if(room=="시갤톡방"&&sg_count<getNum("sg_count")){
			sg_count++
		}
		//else if(room=="시갤톡방"&&sg_count>99&&sender=="시립봇"){
		else if(room=="시갤톡방"&&sg_count>(getNum("sg_count")-1)&&sender=="시립봇"){
			sg_count++
		}
		//else if(room=="시갤톡방"&&sg_count>99&&sender!="시립봇"){ // 포인트 추가
		else if(room=="시갤톡방"&&sg_count>(getNum("sg_count")-1)&&sender!="시립봇"){ // 포인트 추가
			sg_count=0
			if( D.selectForArray("Point",null,"people=?",[sender]) == "" ){ // 포인트를 처음 받은 경우
				if(getDB("LabyChance_"+sender)=="1"){
				...
				D.insert("Point", {people : sender, point : (Math.floor(ran)+20), time : new Date().valueOf()})
				Api.replyRoom("시갤톡방","System : "+sender+"의 시갤톡 포인트 "+(Math.floor(ran)+20)+" 증가!")
			}
			//마이너스 비율
			else if( Number(D.selectForArray("Point","point","people=?",[sender])) < 0 ){ // 마이너스 1배
				var SG_point_temp = Number(D.selectForArray("Point","point","people=?",[sender]))
				if(getDB("LabyChance_"+sender)=="1"){
				...
				D.update("Point", {people : sender, point : SG_point_temp+(Math.floor(ran)+5), time : new Date().valueOf()},"people=?", [sender])
				Api.replyRoom("시갤톡방","System : "+sender+"의 시갤톡 포인트 "+(Math.floor(ran)+5)+" 증가!")
			}
			// 기본 배율 Rand5+5
			else if( Number(D.selectForArray("Point","point","people=?",[sender])) < 50 ){ // 0~49 배율 4배
				var SG_point_temp = Number(D.selectForArray("Point","point","people=?",[sender]))
				if(getDB("LabyChance_"+sender)=="1"){
					var ran = Math.random() * 40
				}
				...
				D.update("Point", {people : sender, point : SG_point_temp+(Math.floor(ran)+20), time : new Date().valueOf()},"people=?", [sender])
				Api.replyRoom("시갤톡방","System : "+sender+"의 시갤톡 포인트 "+(Math.floor(ran)+20)+" 증가!")
			}
			else if( Number(D.selectForArray("Point","point","people=?",[sender])) < 100 ){ // 50~99 배율 3배
				var SG_point_temp = Number(D.selectForArray("Point","point","people=?",[sender]))
				if(getDB("LabyChance_"+sender)=="1"){
					var ran = Math.random() * 30
				}
				else{
					var ran = Math.random() * 15
				}
				D.update("Point", {people : sender, point : SG_point_temp+(Math.floor(ran)+15), time : new Date().valueOf()},"people=?", [sender])
				Api.replyRoom("시갤톡방","System : "+sender+"의 시갤톡 포인트 "+(Math.floor(ran)+15)+" 증가!")
			}
			else if( Number(D.selectForArray("Point","point","people=?",[sender])) < 200 ){ // 100~199 배율 2배
				var SG_point_temp = Number(D.selectForArray("Point","point","people=?",[sender]))
				if(getDB("LabyChance_"+sender)=="1"){
					var ran = Math.random() * 20
				}
				...
				D.update("Point", {people : sender, point : SG_point_temp+(Math.floor(ran)+10), time : new Date().valueOf()},"people=?", [sender])
				Api.replyRoom("시갤톡방","System : "+sender+"의 시갤톡 포인트 "+(Math.floor(ran)+10)+" 증가!")
			}
			else if( Number(D.selectForArray("Point","point","people=?",[sender])) < 300 ){ // 200~299 배율 1배
				var SG_point_temp = Number(D.selectForArray("Point","point","people=?",[sender]))
				if(getDB("LabyChance_"+sender)=="1"){
					var ran = Math.random() * 10
				}
			...
			else if( Number(D.selectForArray("Point","point","people=?",[sender])) < 500 ){ // 300~499 배율 0.5배
				var SG_point_temp = Number(D.selectForArray("Point","point","people=?",[sender]))
				if(getDB("LabyChance_"+sender)=="1"){
				...
				D.update("Point", {people : sender, point : SG_point_temp+(Math.floor(ran)+2), time : new Date().valueOf()},"people=?", [sender])
				Api.replyRoom("시갤톡방","System : "+sender+"의 시갤톡 포인트 "+(Math.floor(ran)+2)+" 증가!")
			}
			else{ // 그 이상 0.25배
				var SG_point_temp = Number(D.selectForArray("Point","point","people=?",[sender]))
				if(getDB("LabyChance_"+sender)=="1"){
				...
				D.update("Point", {people : sender, point : SG_point_temp+(Math.floor(ran)+1), time : new Date().valueOf()},"people=?", [sender])
				Api.replyRoom("시갤톡방","System : "+sender+"의 시갤톡 포인트 "+(Math.floor(ran)+1)+" 증가!")
			}

		else{ // 그 이상 0.25배
			var SG_point_temp = Number(D.selectForArray("Point","point","people=?",[sender]))
			D.update("Point", {people : sender, point : SG_point_temp+(Rand5+5), time : new Date().valueOf()},"people=?", [sender])
		}
			//Api.replyRoom("시갤톡방","System : "+sender+"의 시갤톡 포인트 "+(Rand5+5)+" 증가!")
			setDB("sg_count",20+Math.floor(Math.random() * 160 ))
		}

		if(room=="시갤톡방"&&(msg=="/포인트확인"||msg=="/포인트조회")){
			if(D.selectForArray("Point",null,"people=?",[sender]) == ""){
				Api.replyRoom("시갤톡방",sender+"의 포인트 : 0")
			}
			else{
				Api.replyRoom("시갤톡방",sender+"의 포인트 : "+ Number( D.selectForArray("Point","point","people=?",[sender]) ) )
			}
		}
		*/
		...
		if((room=="시갤톡방"||room=="봇장난")&&msg=="/포인트목록"){
			if( Number(D.selectForArray("Point","point","people=?",[sender]))<10 || D.selectForArray("Point","point","people=?",[sender]) == undefined ){
				Api.replyRoom("시갤톡방","포인트가 모자랍니다. (10 포인트 필요)(현재 잔여 포인트 : "+D.selectForArray("Point","point","people=?",[sender])+")")
			}
			else{
				var SG_point_temp = Number(D.selectForArray("Point","point","people=?",[sender]))
				D.update("Point", {point : SG_point_temp-10},"people=?", [sender])
				r.reply(D.selectForString("Point",["people", "point"],"time>?",[new Date().valueOf()-1000*60*60*24*10],{orderBy:"point desc"}))
				Api.replyRoom("시갤톡방","포인트목록 조회 완료! (10포인트 사용) (현재 잔여 포인트 : "+D.selectForArray("Point","point","people=?",[sender])+")")
			}
		...
		*/
        ...
        if(room=="시갤톡방"&&msg=="/고꿈셔터"&& (Number(D.selectForArray("Point","point","people=?",[sender]))<20 || D.selectForArray("Point","point","people=?",[sender]) == undefined )){
            Api.replyRoom("시갤톡방","포인트가 모자랍니다.")
        }
        else if(room=="시갤톡방"&&msg=="/고꿈셔터"&&Number(D.selectForArray("Point","point","people=?",[sender]))>0){ // 3분간 닥치게 하는 기능
            var SG_point_temp = Number(D.selectForArray("Point","point","people=?",[sender]))
            D.update("Point", {point : SG_point_temp-20},"people=?", [sender])
            setDB("KKshutup",currentTime)
            setDB("Switch_shutup","ON")
            Api.replyRoom("시갤톡방","고1꿈나무 3분간 닥침 기능 활성화")
            Api.replyRoom("시갤톡방",sender+"님의 잔여 포인트 : "+(SG_point_temp-20))
            Api.replyRoom("격리방","System : 3분간 닥침 기능 활성화")
            //setDB("Count_격리방",getNum("Count_격리방")-5);
        }

        // =========================================== 고꿈포인트 주기 =============================================

        if(room=="시갤톡방"&&(msg.indexOf("/고꿈포인트주기")==0||msg.indexOf("/고꿈포인트기부")==0)&&msg.split(" ").length>=2){
            var KKstr = msg.split(" ")
            if(Number(KKstr[1])<=0){
                Api.replyRoom("시갤톡방","올바른 숫자를 넣어주세요")
            }
            else if(KKstr[1].indexOf(".")>-1||KKstr[1].indexOf("-")>-1){
                Api.replyRoom("시갤톡방","정수값만 입력해주세요")
            }
            else if( Number(D.selectForArray("Point","point","people=?",[sender]))<Number(KKstr[1]) || D.selectForArray("Point","point","people=?",[sender]) == undefined ){
                Api.replyRoom("시갤톡방","포인트가 모자랍니다. (현재 잔여 포인트 : "+D.selectForArray("Point","point","people=?",[sender])+")")
            }
            else if( Number(D.selectForArray("Point","point","people=?",[sender]))>Number(KKstr[1]-1) ){
                setDB("Count_격리방",getNum("Count_격리방")+Number(KKstr[1]));
                var SG_point_temp = Number(D.selectForArray("Point","point","people=?",[sender]))
                D.update("Point", {point : SG_point_temp-Number(KKstr[1])},"people=?", [sender])
                Api.replyRoom("시갤톡방","고꿈에게 "+KKstr[1]+"포인트 기부 완료! (현재 잔여 포인트 : "+D.selectForArray("Point","point","people=?",[sender])+")")
                Api.replyRoom("격리방","System : "+sender+"에게 "+KKstr[1]+"포인트를 기부 받았습니다!")
                if(msg.split(" ").length>2){
                    Api.replyRoom("격리방",sender+"가 보내는 메세지 : "+KKstr.slice(2, KKstr.length).join(" "))
                }
            }
        }
        ...
        if(room=="시갤톡방"&&msg.indexOf("/고꿈포인트착취")==0&&msg.split(" ").length>=2){
            var KKstr = msg.split(" ")
            if(Number(KKstr[1])<=0){
                Api.replyRoom("시갤톡방","올바른 숫자를 넣어주세요")
            }
                ...
                var SG_point_temp = Number(D.selectForArray("Point","point","people=?",[sender]))
                D.update("Point", {point : SG_point_temp-Number(KKstr[1])},"people=?", [sender])
                Api.replyRoom("시갤톡방","고꿈에게 "+KKstr[1]+"포인트 착취 완료! (현재 잔여 포인트 : "+D.selectForArray("Point","point","people=?",[sender])+")")
                Api.replyRoom("격리방","System : "+sender+"에게 "+KKstr[1]+"포인트를 착취 당했습니다!")
                if(msg.split(" ").length>2){
                    Api.replyRoom("격리방",sender+"가 보내는 메세지 : "+KKstr.slice(2, KKstr.length).join(" "))
                }
            }
        ...
        if(room=="시갤톡방"&&msg=="/격리방상수선물"){
            if( Number(D.selectForArray("Point","point","people=?",[sender]))<200 || D.selectForArray("Point","point","people=?",[sender]) == undefined ){
                Api.replyRoom("시갤톡방","포인트가 모자랍니다. (200포인트 필요)(현재 잔여 포인트 : "+D.selectForArray("Point","point","people=?",[sender])+")")
            }
            else if( Number(D.selectForArray("Point","point","people=?",[sender]))>=200 ){
                setDB("KKrandom",getNum("KKrandom")+1);
                var SG_point_temp = Number(D.selectForArray("Point","point","people=?",[sender]))
                D.update("Point", {point : SG_point_temp-200},"people=?", [sender])
                Api.replyRoom("시갤톡방","고꿈에게 격리방상수 선물 완료! (현재 잔여 포인트 : "+D.selectForArray("Point","point","people=?",[sender])+")")
                Api.replyRoom("격리방","System : "+sender+"에게 격리방 상수를 선물받았습니다!")
            }
        }

        // =========================================== 복권 =============================================

        if(room=="시갤톡방"&&msg=="/즉석복권"){
            if( Number(D.selectForArray("Point","point","people=?",[sender]))<10 || D.selectForArray("Point","point","people=?",[sender]) == undefined ){
                Api.replyRoom("시갤톡방","포인트가 모자랍니다. (10포인트 필요)(현재 잔여 포인트 : "+D.selectForArray("Point","point","people=?",[sender])+")")
            }
            else{
                var SG_point_temp = Number(D.selectForArray("Point","point","people=?",[sender]))
                D.update("Point", {people : sender, point : SG_point_temp-10},"people=?", [sender])
                if(Rand10000>-1&&Rand10000<1001){ // 0~1000
                    Api.replyRoom("시갤톡방","System : 5등 당첨! 포인트 20 증가!")
                    D.update("Point", {people : sender, point : SG_point_temp+20},"people=?", [sender])
                }
                else if(Rand10000>1000&&Rand10000<1401){ // 1001~1400
                    Api.replyRoom("시갤톡방","System : 4등 당첨! 포인트 50 증가!")
                    D.update("Point", {people : sender, point : SG_point_temp+50},"people=?", [sender])
                }
                else if(Rand10000>1400&&Rand10000<1501){ // 1401~1500
                    Api.replyRoom("시갤톡방","System : 3등 당첨! 포인트 100 증가!")
                    D.update("Point", {people : sender, point : SG_point_temp+100},"people=?", [sender])
                }
                else if(Rand10000>1500&&Rand10000<1511){ // 1501~1510
                    Api.replyRoom("시갤톡방","System : 2등 당첨! 포인트 1000 증가!")
                    D.update("Point", {people : sender, point : SG_point_temp+1000},"people=?", [sender])
                }
                else if(Rand10000==1511){ // 1511
                    Api.replyRoom("시갤톡방","System : 1등 당첨! 포인트 10000 증가!")
                    D.update("Point", {people : sender, point : SG_point_temp+10000},"people=?", [sender])
                }
                else{
        ...
        else if(room=="시갤톡방"&&msg.indexOf("/즉석복권")==0){
            var number_try = Number(msg.substr(6))
            if( Number(msg.substr(6)) <= 0 ){
                Api.replyRoom("시갤톡방","올바른 숫자를 넣어주세요")
            }
            else if( msg.substr(6).indexOf(".")>-1 || msg.substr(6).indexOf("-")>-1 ){
                Api.replyRoom("시갤톡방","정수값만 입력해주세요")
            }
            else if( Number(D.selectForArray("Point","point","people=?",[sender])) < 10*number_try || D.selectForArray("Point","point","people=?",[sender]) == undefined ){
                Api.replyRoom("시갤톡방","포인트가 모자랍니다.")
            }
            else if( Number(D.selectForArray("Point","point","people=?",[sender])) >= 10*number_try ){
                var win5 = 0;
                var win4 = 0;
                var win3 = 0;
                var win2 = 0;
                ...
                var lose = 0;
                var SG_point_temp = Number(D.selectForArray("Point","point","people=?",[sender]))
                D.update("Point", {people : sender, point : SG_point_temp-10*number_try},"people=?", [sender])
                for(var i=0 ; i<number_try ; i++){
                    var ran = Math.floor(Math.random()*10000)
                    if( ran >-1 && ran <1001){ // 0~1000
                        win5++
                    }
                    else if( ran >1000&& ran <1401){ // 1001~1400
                        win4++
                    }
                    else if( ran >1400&& ran <1501){ // 1401~1500
                        win3++
                    }
                    else if( ran >1500&& ran <1511){ // 1501~1510
                        win2++
                    }
                    else if( ran ==1511){ // 1511
                        win1++
                    }
                    else{
                        lose++
                ...
                var str = ""
                var reward = win5*20+win4*50+win3*100+win2*1000+win1*10000
                str += "1등 당첨 횟수 : "+win1+"회\n";
                str += "2등 당첨 횟수 : "+win2+"회\n";
                str += "3등 당첨 횟수 : "+win3+"회\n";
                str += "4등 당첨 횟수 : "+win4+"회\n";
                str += "5등 당첨 횟수 : "+win5+"회\n";
                str += "낙첨 횟수 : "+lose+"회\n";
                str += "총 당첨금 : "+reward+"포인트";
                var SG_point_temp = Number(D.selectForArray("Point","point","people=?",[sender]))
                D.update("Point", {people : sender, point : SG_point_temp+reward},"people=?", [sender])
                Api.replyRoom("시갤톡방",str)
            }
            else{
                Api.replyRoom("봇장난","복권에러")
            }
        }
        ...
        if(room=="시갤톡방"&&msg.indexOf("/채팅추적")==0){ // /채팅추적 [추적갯수] [추적대상]
            var pass_CTCZ = 0 // 0:포인트부족, 1:통과, 2:범위초과
            var point_use = 0 // 사용되는 포인트
            var CTCZ_cnt = 0 // 추적할 채팅의 수
            if( Number(msg.split(" ")[1]) <= 0 ){
                Api.replyRoom("시갤톡방","올바른 숫자를 넣어주세요")
            }
            else if( msg.split(" ")[1].indexOf(".")>-1 || msg.split(" ")[1].indexOf("-")>-1 ){
                Api.replyRoom("시갤톡방","정수값만 입력해주세요")
            }
            else if( Number(msg.split(" ")[1]) <= 5 ){ // 1~5 : 3point
                if( Number(D.selectForArray("Point","point","people=?",[sender]))<=3 || D.selectForArray("Point","point","people=?",[sender]) == undefined ){
                    pass_CTCZ = 0
                }
                else{
                    pass_CTCZ = 1
                    point_use = 3
                    CTCZ_cnt = msg.split(" ")[1]
                }
            }
            else if( Number(msg.split(" ")[1]) <= 20 ){ // 6~20 : 5point
                if( Number(D.selectForArray("Point","point","people=?",[sender]))<=5 || D.selectForArray("Point","point","people=?",[sender]) == undefined ){
                    pass_CTCZ = 0
                }
                else{
                    pass_CTCZ = 1
            ...
            /*
			else if( Number(msg.split(" ")[1]) <= 50 ){ // 21~50 : 10point
				if( Number(D.selectForArray("Point","point","people=?",[sender]))<=10 || D.selectForArray("Point","point","people=?",[sender]) == undefined ){
					pass_CTCZ = 0
				}
				else{
			...
			else if( Number(msg.split(" ")[1]) <= 100 ){ // 51~100 : 30point
				if( Number(D.selectForArray("Point","point","people=?",[sender]))<=30 || D.selectForArray("Point","point","people=?",[sender]) == undefined ){
					pass_CTCZ = 0
				}
				else{
					pass_CTCZ = 1
			...
			*/
            ...
            if(pass_CTCZ==0){
                ...
                Api.replyRoom("시갤톡방","20개 이하의 채팅만 추적이 가능합니다.")
            }
            else if(pass_CTCZ==1){
                if(msg.split(" ")[2]==undefined||msg.split(" ")[2]==""){
                    var SG_point_temp = Number(D.selectForArray("Point","point","people=?",[sender]))
                    D.update("Point", {people : sender, point : SG_point_temp-point_use},"people=?", [sender])
                    var CTCZ_text = show("시갤톡방","",CTCZ_cnt)
                    Api.replyRoom("시갤톡방",CTCZ_text)
                    Api.replyRoom("시갤톡방","System : "+point_use+"포인트를 사용했습니다!")
                }
                else{
                    var SG_point_temp = Number(D.selectForArray("Point","point","people=?",[sender]))
                    D.update("Point", {people : sender, point : SG_point_temp-point_use},"people=?", [sender])
                    var CTCZ_text = show("시갤톡방",msg.split(" ").slice(2,msg.length).join(" "),CTCZ_cnt)
                    Api.replyRoom("시갤톡방",CTCZ_text)
                    Api.replyRoom("시갤톡방","System : "+point_use+"포인트를 사용했습니다!")
                }
            }
	...
	if(room=="봇장난"&&msg.indexOf("/메세지알림")){
		...
		try{
			var time_pre = msg.split(" ")[1]
		}
		catch(e){
			Api.replyRoom("봇장난","에러 1")
		}

		if(time_pre.search(":")=="2"&&time_pre.length==9){
			hh = Number( time_pre.split(":")[0] ) // 시
			mm = Number( time_pre.split(":")[1] ) // 분
			ss = Number( time_pre.split(":")[2] ) // 초
		}
		else{
			Api.replyRoom("시갤톡방","시간 양식을 올바르게 입력해주세요 (hh:mm:ss)")
			return 0;
		}

		var msgWant = msg.split(" ").slice(2).join(" ")

		var time = Number(hh*3600000+mm*60000+ss*1000)

		if( Number(hh) == NaN || Number(hh)>24){
			Api.replyRoom("시갤톡방","올바른 시간을 넣어주세요")
			return 0;
		}
		else if(  msgWant == "" ||  msgWant == undefined ){
			Api.replyRoom("시갤톡방","메세지를 입력해주세요")
			return 0;
		}
		else if( Number(mm) == NaN || Number(hh)>60){
			Api.replyRoom("시갤톡방","올바른 시간을 넣어주세요")
			return 0;
		}
		else if( Number(ss) == NaN || Number(hh)>60){
			Api.replyRoom("시갤톡방","올바른 시간을 넣어주세요")
			return 0;
		}
		else if( Number(time) == NaN ){
			Api.replyRoom("시갤톡방","올바른 시간을 넣어주세요")
			return 0;
		}
		else if( Number(time) <= 60*1000 ){ // ~1분 : 1point
			if( Number(D.selectForArray("Point","point","people=?",[sender]))<=1 || D.selectForArray("Point","point","people=?",[sender]) == undefined ){
				pass_CTCZ = 0
			}
			else{
				pass_CTCZ = 1
		...
		else if( Number(time) <= 10*60*1000 ){ // ~10분 : 3point
			if( Number(D.selectForArray("Point","point","people=?",[seㅇnder]))<=3 || D.selectForArray("Point","point","people=?",[sender]) == undefined ){
				pass_CTCZ = 0
			}
			else{
				pass_CTCZ = 1
		...
		else if( Number(time) <= 60*60*1000 ){ // ~1시간 : 10point
			if( Number(D.selectForArray("Point","point","people=?",[sender]))<=10 || D.selectForArray("Point","point","people=?",[sender]) == undefined ){
				pass_CTCZ = 0
			}
			else{
		...
		else if( Number(time) <= 24*60*60*1000 ){ // ~24시간 : 30point
			if( Number(D.selectForArray("Point","point","people=?",[sender]))<=30 || D.selectForArray("Point","point","people=?",[sender]) == undefined ){
				pass_CTCZ = 0
			}
			else{
		...
		if(pass_CTCZ==0){
			...
			Api.replyRoom("시갤톡방","24시간 이하로만 설정 가능합니다.")
		}
		else if(pass_CTCZ==1){
			var SG_point_temp = Number(D.selectForArray("Point","point","people=?",[sender]))
			D.update("Point", {people : sender, point : SG_point_temp-point_use},"people=?", [sender])
			Api.replyRoom("시갤톡방","System : "+point_use+"포인트를 사용했습니다!")
			Api.replyRoom("시갤톡방",msgWant)
		}
	}
	*/
        ...
        if(room=="시갤톡방"&&msg.indexOf("/고꿈대출포인트주기")==0&&msg.split(" ").length>=2){
            var KKstr = msg.split(" ")
            if(Number(KKstr[1])<=0){
                Api.replyRoom("시갤톡방","올바른 숫자를 넣어주세요")
            }
            ...
            else if( Number(D.selectForArray("Point","point","people=?",[sender]))< (10*Number(KKstr[1])) || D.selectForArray("Point","point","people=?",[sender]) == undefined ){
                Api.replyRoom("시갤톡방","포인트가 모자랍니다. (현재 잔여 포인트 : "+D.selectForArray("Point","point","people=?",[sender])+")")
            }
            else if( Number(D.selectForArray("Point","point","people=?",[sender]))>Number(KKstr[1]-1) ){
                setDB( "Count_대출",getNum("Count_대출")+Number(KKstr[1]) );
                var SG_point_temp = Number(D.selectForArray("Point","point","people=?",[sender]))
                D.update("Point", {point : SG_point_temp-(10*Number(KKstr[1]))},"people=?", [sender])
                Api.replyRoom("시갤톡방","고꿈에게 대출포인트 "+KKstr[1]+"기부 완료! (현재 잔여 포인트 : "+D.selectForArray("Point","point","people=?",[sender])+")")
                Api.replyRoom("격리방","System : "+sender+"에게 대출포인트를"+KKstr[1]+" 기부 받았습니다!")
                if(msg.split(" ").length>2){
                    Api.replyRoom("격리방",sender+"가 보내는 메세지 : "+KKstr.slice(2, KKstr.length).join(" "))
                }
            }
        ...
        if(room=="시갤톡방"&&msg=="/부방장목록"){
            var last=getNum("last_master_SG");
            var tmp="- 부방장 목록 -\n";
            for(var i=0; i<3; i++){
                tmp+=getDB("SG_master_"+((last+i-1)%3+1))+"\n";
            }
            Api.replyRoom("시갤톡방",tmp.rmspace());
        }



        if(room=="시갤톡방"&&msg=="/부방장복권"){
            //방장 임기 최소 3일로 설정
            /*
			if( currentTime - getDB("SG_master_time") < 3*24*60*60*1000){
				Api.replyRoom("시갤톡방","아직 방장들의 임기가 남아있습니다.")
				var minTime = getNum("SG_master_time")
				var leaveTime = 3*24*60*60*1000 - (currentTime - minTime)
				var SG_day = Math.floor(leaveTime / (24*60*60*1000))
				var SG_hours = Math.floor(leaveTime / (60*60*1000)) - SG_day*24
				var SG_min = Math.floor(leaveTime / (60*1000)) - SG_day*24*60 - SG_hours*60
				Api.replyRoom("시갤톡방",SG_day+"일 "+SG_hours+"시간 "+SG_min+"분 후에 다시 시도해주세요.")
			}
			*/
            if( Number(D.selectForArray("Point","point","people=?",[sender]))<10 || D.selectForArray("Point","point","people=?",[sender]) == undefined ){
                Api.replyRoom("시갤톡방","포인트가 모자랍니다. (10포인트 필요)(현재 잔여 포인트 : "+D.selectForArray("Point","point","people=?",[sender])+")")
                ...
                var SG_point_temp = Number(D.selectForArray("Point","point","people=?",[sender]))
                D.update("Point", {people : sender, point : SG_point_temp-10},"people=?", [sender])
                if(Rand10000>-1&&Rand10000<101){ // 0~100 // 당첨확률 1퍼센트
                    Api.replyRoom("시갤톡방","System : 부방장 당첨!")
                    var delete_master = getDB("SG_master"+getDB("last_master_SG")) // 임기 끝난 방장
                    setDB("SG_master_"+getDB("last_master_SG"),sender) // 새로운 방장
                    setDB("SG_master_time_"+getDB("last_master_SG"),currentTime) // 새로운 방장 임기 시작 시간
                    if(getNum("last_master_SG")<3){
                        setDB("last_master_SG",getNum("last_master_SG")+1)
                    }
                    else{
                        setDB("last_master_SG",1)
                    }
                    var str = delete_master+"의 임기가 종료되고 "+sender+"가 새로운 부방장이 되었습니다."
                    Api.replyRoom("시갤톡방",str)
                    Api.replyRoom("봇장난","시갤톡방\n"+str);
                }
                else{
                    Api.replyRoom("시갤톡방","System : 꽝!")
                }
        ...
        else if(room=="시갤톡방"&&msg.indexOf("/부방장복권")==0&&getDB("LabyChance_"+sender)=="1") { //일반
            var number_try = Number(msg.substr(7))
            if (Number(msg.substr(7)) <= 0) {
                Api.replyRoom("시갤톡방", "올바른 숫자를 넣어주세요")
            } else if (msg.substr(7).indexOf(".") > -1 || msg.substr(7).indexOf("-") > -1) {
                Api.replyRoom("시갤톡방", "정수값만 입력해주세요")
            } else if (Number(D.selectForArray("Point", "point", "people=?", [sender])) < 10 * number_try || D.selectForArray("Point", "point", "people=?", [sender]) == undefined) {
                Api.replyRoom("시갤톡방", "포인트가 모자랍니다.")
            } else if (Number(D.selectForArray("Point", "point", "people=?", [sender])) >= 10 * number_try) {
                ...
                for (var i = 0; i < number_try; i++) {
                    var ran = Math.floor(Math.random() * 10000)
                    if (sender == "베비꿍") { //블랙리스트 (2019/7/10) (사유 : 꼬리선 밴해제)
                        lose++
                    }
                    else if (sender == "힘강") { //블랙리스트
                        lose++
                    } else if (ran > -1 && ran < 301) { // 0~100
                        win++
                    } else {
                        lose++
                    }
                ...
                if (win > 0) {
                    Api.replyRoom("시갤톡방", "System : 부방장 당첨!")
                    var delete_master = getDB("SG_master_" + getDB("last_master_SG")) // 임기 끝난 방장
                    setDB("SG_master_" + getDB("last_master_SG"), sender) // 새로운 방장
                    setDB("SG_master_time_" + getDB("last_master_SG"), currentTime) // 새로운 방장 임기 시작 시간
                    if (getNum("last_master_SG") < 3) {
                        setDB("last_master_SG", getNum("last_master_SG") + 1)
				...
				if(win>0){
					Api.replyRoom("시갤톡방","System : 부방장 당첨!")
					var delete_master = getDB("SG_master") // 임기 끝난 방장
					setDB("SG_master",sender) // 새로운 방장
					setDB("SG_master_time",currentTime) // 새로운 방장 임기 시작 시간
					var str = delete_master+"의 임기가 종료되고 "+sender+"가 새로운 부방장이 되었습니다."
					Api.replyRoom("시갤톡방",str)
				}
				*/
        ...
        else if(room=="시갤톡방"&&msg.indexOf("/부방장복권")==0&&getDB("LabyChance_"+sender)=="0"){ //일반
            var number_try = Number(msg.substr(7))
            if( Number(msg.substr(7)) <= 0 ){
                Api.replyRoom("시갤톡방","올바른 숫자를 넣어주세요")
            }
...
//=====================================================================================================================================
        ...
        if(room=="전전컴아싸방"&&ECE_count<getNum("ECE_count")){
            ECE_count++
        }
        //else if(room=="시갤톡방"&&sg_count>99&&sender=="시립봇"){
        else if(room=="전전컴아싸방"&&ECE_count>(getNum("ECE_count")-1)&&sender=="시립봇"){
            ECE_count++
        }
        //else if(room=="시갤톡방"&&sg_count>99&&sender!="시립봇"){ // 포인트 추가
        else if(room=="전전컴아싸방"&&ECE_count>(getNum("ECE_count")-1)&&sender!="시립봇"){ // 포인트 추가
            ECE_count=0
            if( D.selectForArray("Point_ECE",null,"people=?",[sender]) == "" ){ // 포인트를 처음 받은 경우
                var ran = Math.random() * 20
                D.insert("Point_ECE", {people : sender, point : (Math.floor(ran)+20), time : new Date().valueOf()})
                Api.replyRoom("전전컴아싸방","System : "+sender+"의 포인트 "+(Math.floor(ran)+20)+" 증가!")
            }
            //마이너스 비율
            else if( Number(D.selectForArray("Point_ECE","point","people=?",[sender])) < 0 ){ // 마이너스 1배
                var ran = Math.random() * 5
                var ECE_point_temp = Number(D.selectForArray("Point_ECE","point","people=?",[sender]))
                D.update("Point_ECE", {people : sender, point : ECE_point_temp+(Math.floor(ran)+5), time : new Date().valueOf()},"people=?", [sender])
                Api.replyRoom("전전컴아싸방","System : "+sender+"의 포인트 "+(Math.floor(ran)+5)+" 증가!")
            }
            // 기본 배율 Rand5+5
            else if( Number(D.selectForArray("Point_ECE","point","people=?",[sender])) < 50 ){ // 0~49 배율 4배
                var ran = Math.random() * 20
                var ECE_point_temp = Number(D.selectForArray("Point_ECE","point","people=?",[sender]))
                D.update("Point_ECE", {people : sender, point : ECE_point_temp+(Math.floor(ran)+20), time : new Date().valueOf()},"people=?", [sender])
                Api.replyRoom("전전컴아싸방","System : "+sender+"의 포인트 "+(Math.floor(ran)+20)+" 증가!")
            }
            else if( Number(D.selectForArray("Point_ECE","point","people=?",[sender])) < 100 ){ // 50~99 배율 3배
                var ran = Math.random() * 15
                var ECE_point_temp = Number(D.selectForArray("Point_ECE","point","people=?",[sender]))
                D.update("Point_ECE", {people : sender, point : ECE_point_temp+(Math.floor(ran)+15), time : new Date().valueOf()},"people=?", [sender])
                Api.replyRoom("전전컴아싸방","System : "+sender+"의 포인트 "+(Math.floor(ran)+15)+" 증가!")
            }
            else if( Number(D.selectForArray("Point_ECE","point","people=?",[sender])) < 200 ){ // 100~199 배율 2배
                var ran = Math.random() * 10
                var ECE_point_temp = Number(D.selectForArray("Point_ECE","point","people=?",[sender]))
                D.update("Point_ECE", {people : sender, point : ECE_point_temp+(Math.floor(ran)+10), time : new Date().valueOf()},"people=?", [sender])
                Api.replyRoom("전전컴아싸방","System : "+sender+"의 포인트 "+(Math.floor(ran)+10)+" 증가!")
            }
            else if( Number(D.selectForArray("Point_ECE","point","people=?",[sender])) < 300 ){ // 200~299 배율 1배
                var ran = Math.random() * 5
                var ECE_point_temp = Number(D.selectForArray("Point_ECE","point","people=?",[sender]))
                D.update("Point_ECE", {people : sender, point : ECE_point_temp+(Math.floor(ran)+5), time : new Date().valueOf()},"people=?", [sender])
                Api.replyRoom("전전컴아싸방","System : "+sender+"의 포인트 "+(Math.floor(ran)+5)+" 증가!")
            }
            else if( Number(D.selectForArray("Point_ECE","point","people=?",[sender])) < 500 ){ // 300~499 배율 0.5배
                var ran = Math.random() * 3
                var ECE_point_temp = Number(D.selectForArray("Point_ECE","point","people=?",[sender]))
                D.update("Point_ECE", {people : sender, point : ECE_point_temp+(Math.floor(ran)+2), time : new Date().valueOf()},"people=?", [sender])
                Api.replyRoom("전전컴아싸방","System : "+sender+"의 포인트 "+(Math.floor(ran)+2)+" 증가!")
            }
            else{ // 그 이상 0.25배
                var ran = Math.random() * 2
                var ECE_point_temp = Number(D.selectForArray("Point_ECE","point","people=?",[sender]))
                D.update("Point_ECE", {people : sender, point : ECE_point_temp+(Math.floor(ran)+1), time : new Date().valueOf()},"people=?", [sender])
                Api.replyRoom("전전컴아싸방","System : "+sender+"의 포인트 "+(Math.floor(ran)+1)+" 증가!")
            }
            /*
		else{ // 그 이상 0.25배
			var ECE_point_temp = Number(D.selectForArray("Point_ECE","point","people=?",[sender]))
			D.update("Point_ECE", {people : sender, point : ECE_point_temp+(Rand5+5), time : new Date().valueOf()},"people=?", [sender])
		}*/
            //Api.replyRoom("시갤톡방","System : "+sender+"의 시갤톡 포인트 "+(Rand5+5)+" 증가!")
            setDB("ECE_count",20+Math.floor(Math.random() * 160 ))
        }

        if(room=="전전컴아싸방"&&(msg=="/포인트확인"||msg=="/포인트조회")){
            if(D.selectForArray("Point_ECE",null,"people=?",[sender]) == ""){
                Api.replyRoom("전전컴아싸방",sender+"의 포인트 : 0")
            }
            else{
                Api.replyRoom("전전컴아싸방",sender+"의 포인트 : "+ Number( D.selectForArray("Point_ECE","point","people=?",[sender]) ) )
            }
        }

        if(room=="전전컴아싸방"&&msg=="/포인트목록"){
            if( Number(D.selectForArray("Point_ECE","point","people=?",[sender]))<10 || D.selectForArray("Point_ECE","point","people=?",[sender]) == undefined ){
                Api.replyRoom("전전컴아싸방","포인트가 모자랍니다. (10 포인트 필요)(현재 잔여 포인트 : "+D.selectForArray("Point_ECE","point","people=?",[sender])+")")
            }
            else{
                var ECE_point_temp = Number(D.selectForArray("Point_ECE","point","people=?",[sender]))
                D.update("Point_ECE", {point : ECE_point_temp-10},"people=?", [sender])
                r.reply(D.selectForString("Point_ECE",["people", "point"],"time>?",[new Date().valueOf()-1000*60*60*24*10],{orderBy:"point desc"}))
                Api.replyRoom("전전컴아싸방","포인트목록 조회 완료! (10포인트 사용) (현재 잔여 포인트 : "+D.selectForArray("Point_ECE","point","people=?",[sender])+")")
            }

        }
        if(room=="전전컴아싸방"&&msg=="/부방장목록"){
            var last=getNum("last_master");
            var tmp="- 부방장 목록 -\n";
            for(var i=0; i<5; i++){
                tmp+=getDB("ECE_master_"+((last+i-1)%5+1))+"\n";
            }
            tmp+="당첨 확률 : "+ (1+(new Date()-getNum("ECE_master_time"))/86400000).toFixed(6)+"%"
            Api.replyRoom("전전컴아싸방",tmp);
        }
        if(room=="전전컴아싸방"&&msg=="/부방장복권"){
            //방장 임기 최소 14일로 설정
            /*
			if( currentTime - getDB("ECE_master_time_1") < 1*24*60*60*1000 && currentTime - getDB("ECE_master_time_2") < 14*24*60*60*1000 && currentTime - getDB("ECE_master_time_3") < 14*24*60*60*1000 ){
				Api.replyRoom("전전컴아싸방","아직 방장들의 임기가 남아있습니다.")
				var minTime = Math.min(getNum("ECE_master_time_1"),getNum("ECE_master_time_2"),getNum("ECE_master_time_3"))
				var leaveTime = 14*24*60*60*1000 - (currentTime - minTime)
				var ECE_day = Math.floor(leaveTime / (24*60*60*1000))
				var ECE_hours = Math.floor(leaveTime / (60*60*1000)) - ECE_day*24
				var ECE_min = Math.floor(leaveTime / (60*1000)) - ECE_day*24*60 - ECE_hours*60
				Api.replyRoom("전전컴아싸방",ECE_day+"일 "+ECE_hours+"시간 "+ECE_min+"분 후에 다시 시도해주세요.")
			}
			*/
            if(sender==getDB("ECE_master_1") || sender==getDB("ECE_master_2") || sender==getDB("ECE_master_3") || sender==getDB("ECE_master_4") || sender==getDB("ECE_master_5")){
                Api.replyRoom("전전컴아싸방","현재 부방장은 부방장 복권을 이용할 수 없습니다.");
            }
            else if( Number(D.selectForArray("Point_ECE","point","people=?",[sender]))<10 || D.selectForArray("Point_ECE","point","people=?",[sender]) == undefined ){
                Api.replyRoom("전전컴아싸방","포인트가 모자랍니다. (10포인트 필요)(현재 잔여 포인트 : "+D.selectForArray("Point_ECE","point","people=?",[sender])+")")
            }
            else{
                var ECE_point_temp = Number(D.selectForArray("Point_ECE","point","people=?",[sender]))
                D.update("Point_ECE", {people : sender, point : ECE_point_temp-10},"people=?", [sender])
                if(getDB("SG_list").split("||").indexOf(sender)>-1 && Math.random()<0.01+(new Date()-getNum("ECE_master_time"))/86400000*0.05){ // 대상이 시갤러일 경우 확률 주작
                    Api.replyRoom("전전컴아싸방","System : 부방장 당첨!")
                    var delete_master = getDB("ECE_master_"+getDB("last_master")) // 임기 끝난 방장
                    setDB("ECE_master_"+getDB("last_master"),sender) // 새로운 방장
                    setDB("ECE_master_time_"+getDB("last_master"),currentTime) // 새로운 방장 임기 시작 시간
                    setDB("ECE_master_time", new Date().valueOf()); //마지막 당첨된 시간
                    setDB("last_master",getNum("last_master")%5+1); //+1, 값이 5일때는 1으로
                    var str = delete_master+"의 임기가 종료되고 "+sender.이가()+" 새로운 부방장이 되었습니다."
                    Api.replyRoom("전전컴아싸방",str);
                    Api.replyRoom("봇장난","전전컴아싸방\n"+str);
                }
                else if(Math.random()<0.01+(new Date()-getNum("ECE_master_time"))/86400000*0.01){ // 기본 1%, 하루에 1% 증가
                    Api.replyRoom("전전컴아싸방","System : 부방장 당첨!")
                    var delete_master = getDB("ECE_master_"+getDB("last_master")) // 임기 끝난 방장
                    setDB("ECE_master_"+getDB("last_master"),sender) // 새로운 방장
                    setDB("ECE_master_time_"+getDB("last_master"),currentTime) // 새로운 방장 임기 시작 시간
                    ...
                    Api.replyRoom("전전컴아싸방","System : 꽝!")
                }
            }

        }
        else if(room=="전전컴아싸방"&&msg.indexOf("/부방장복권")==0){
            var number_try = Number(msg.substr(7))
            /*
        if( currentTime - getDB("ECE_master_time_1") < 1*24*60*60*1000 && currentTime - getDB("ECE_master_time_2") < 14*24*60*60*1000 && currentTime - getDB("ECE_master_time_3") < 14*24*60*60*1000 ){
            Api.replyRoom("전전컴아싸방","아직 방장들의 임기가 남아있습니다.")
        ...
        */
            ...
            else if( Number(msg.substr(7)) <= 0 ){
                Api.replyRoom("전전컴아싸방","올바른 숫자를 넣어주세요")
            }
            else if( msg.substr(7).indexOf(".")>-1 || msg.substr(7).indexOf("-")>-1 ){
                Api.replyRoom("전전컴아싸방","정수값만 입력해주세요")
            }
            else if( Number(D.selectForArray("Point_ECE","point","people=?",[sender])) < 10*number_try || D.selectForArray("Point_ECE","point","people=?",[sender]) == undefined ){
                Api.replyRoom("전전컴아싸방","포인트가 모자랍니다.")
            }
            else if( Number(D.selectForArray("Point_ECE","point","people=?",[sender])) >= 10*number_try ){
                var win = 0;
                var lose = 0;
                var ECE_point_temp = Number(D.selectForArray("Point_ECE","point","people=?",[sender]))
                D.update("Point_ECE", {people : sender, point : ECE_point_temp-10*number_try},"people=?", [sender])
                for(var i=0 ; i<number_try ; i++){
                    //var ran = Math.floor(Math.random()*10000)
                    if(Math.random()<0.01+(new Date()-getNum("ECE_master_time"))/86400000*0.01){ // 기본 1%, 하루에 1% 증가
                        win++
                    }
                    else{
                        lose++
            ...
            for(let i=0;i<num_body;i++){
                ...
                try{
                    ...
                    if( comm_body[i].split("$$$")[3] == "identity_multy_v3" ){
                        let nickName = String(comm_body[i].split("$$$")[4]).split("$%$")[0]
                        let id = String(comm_body[i].split("$$$")[4]).split("$%$")[1]
                        let body = "$$$"+(i+1)+"$$$"+comm_body[i].split("$$$")[2]+"$$$"+"return_identity_multi_v3"+"$$$"+nickName+"$%$"+NSC1(id)
                        purge(id)
                        Api.replyRoom("통신방",body)
                        java.lang.Thread.sleep(500)
                    }
...
function sendKalingImage(room, imageURL, URL, description,button,width, height){
    ...
    try{
        ...
        Api.replyRoom("봇장난","try")
    }catch(e){
        kakaoReset();
        Kakao.send(room, kalingObj );
        Api.replyRoom("봇장난",e)
        Api.replyRoom("봇장난","catch")
    }
...
function update() {
	updateStart=1
    Api.replyRoom("봇장난","업데이트 시작");
    timer.start()
	//var checksum=Utils.getWebText('https://github.com/Schwalbe262/uosgall_bot/commits/master').split('repository-content')[1].split('commit/')[1].split('"')[0];
   var checksum=Utils.getWebText('https://github.com/Schwalbe262/uosgall_bot/commits/master').split('repository-content')[1].split('commit/')[1].split('"')[0];
   var conn = new java.net.URL("https://raw.githubusercontent.com/Schwalbe262/uosgall_bot/"+checksum+"/response.js").openConnection();
   conn.setRequestProperty("Content-Type", "text/xml;charset=utf-8");
   var is=conn.getInputStream();
   var br=new java.io.BufferedReader(new java.io.InputStreamReader(is));
   //var scan = new java.util.Scanner(is);
   ...
   br.close();
   var date= new Date()
  var bakname = ("response_"+date.getFullYear() +"-" +(date.getMonth()+1)+"-" +date.getDate()+"-"+date.getHours()+":"+date.getMinutes()+":"+date.getSeconds()+".bak") ;
  saveFile("/backup/"+bakname,readFile("response.js"));
  saveFile("response.js", str);
  Api.replyRoom("봇장난","업데이트 완료");
  msg = "경과시간: " + java.lang.String.format("%.2f",timer.end()/1000) + "초";
  Api.replyRoom("봇장난",msg);
	switcher=0;
}
    ...
    run:function(){
        ...
        try{
            ...
            while(1){
				...
				try{
					java.lang.Thread.sleep(15000) //1sec
					Api.replyRoom("고양이 사진방","지우기 테스트")
					//Api.replyRoom("봇장난","UOSP4작동\n"+make_time())

				}catch(e){
					Api.replyRoom("봇장난","API replyRoom error\n"+e + "\n" + e.stack + "\n" + e.rhinoException + "\n" + e.lineNumber);
					java.lang.Thread.sleep(15000) //1sec
				}
				*/
				...
				try{
					...
					Api.replyRoom("봇장난","UOSP_corona error\n"+e + "\n" + e.stack + "\n" + e.rhinoException + "\n" + e.lineNumber);
					java.lang.Thread.sleep(15000) //1sec
				}
				*/
                /*
...
function get_authroization_header(){
    ...
    var get_auth_token = () => {
            return readFile2("/data/data/com.kakao.talk/shared_prefs/KakaoTalk.authorization.preferences.xml").split("<string name=\"encrypted_auth_token\">")[1].split("</string")[0];
        }
    ;
    var get_device_uuid = () => {
            return readFile2("/data/data/com.kakao.talk/shared_prefs/KakaoTalk.hw.perferences.xml").split("<string name=\"deviceUUID\">")[1].split("</string")[0];
        }
    ;
...
var get_auth_token = () => {
    ...
    return readFile2("/sdcard/KakaoTalk.authorization.preferences.xml").split("<string name=\"encrypted_auth_token\">")[1].split("</string")[0];
}
...
var get_device_uuid =
    () => {
        ...
        return readFile2("/sdcard/KakaoTalk.hw.perferences.xml").split("<string name=\"deviceUUID\">")[1].split("</string")[0];
    }


var get_device_adid = () => {
    cmd("cp /data/data/com.kakao.talk/shared_prefs/com.kakao.talk_preferences.xml /sdcard/");
    return readFile2("/sdcard/com.kakao.talk_preferences.xml").split("<string name=\"adfit_adid\">")[1].split("</string")[0];
}
